...
class UserRegisterForm(UserCreationForm):
    username = forms.CharField(label="Имя пользователя", help_text='Здесь будет подсказка при регистрации', widget=forms.TextInput(attrs={'class': 'form-control', 'autocomplete': 'off'}))
